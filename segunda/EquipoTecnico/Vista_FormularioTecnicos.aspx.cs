...
namespace segunda
{
    public partial class WebForm16 : System.Web.UI.Page
    {
        ...
        protected void botonEnviar_Click(object sender, EventArgs e)
        {
            ...
            // Establecer la variable de sesión para indicar que los datos se han guardado
            Session["DatosGuardados"] = true;
        ...
        protected void btnPDF_Click(object sender, EventArgs e)
        {
            ...
            {
                string tecnico = DropDownListtxttecnico.SelectedItem.Text;
                string cliente = ddlCliente.SelectedItem.Text;
                string tienda = ddlTienda.SelectedItem.Text;
                string correo = txtCorreo.Text;
                DateTime fecha = DateTime.Parse(txtfecha.Text);
                ...
                Session["TipoTrabajo"] = tipoTrabajo;
