<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Vista_AgregarCliente.aspx.cs" Inherits="segunda.WebForm5" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container mt-4 border p-4 rounded" style="max-width: 600px; margin: 0 auto;">
        ...
        <div class="mb-3">
            <asp:Label ID="rcliente" runat="server" Text="Rut:" CssClass="form-label"></asp:Label>
            <asp:TextBox ID="txtrcliente" runat="server" CssClass="form-control"></asp:TextBox>
         </div>

        <div class="mb-3">
            <asp:Label ID="nombrecliente" runat="server" Text="Nombre del Cliente:" CssClass="form-label"></asp:Label>
            <asp:TextBox ID="txtnombrecliente" runat="server" CssClass="form-control"></asp:TextBox>
        </div>

        <div class="mb-3">
            <asp:Label ID="direccioncliente" runat="server" Text="Direcion del Cliente:" CssClass="form-label"></asp:Label>
      ...
      <div>
        ...
        <asp:GridView ID="GridViewCliente" runat="server" AutoGenerateColumns="false" OnRowDeleting="GridViewCliente_RowDeleting">
     <Columns>
         
         <asp:BoundField DataField="IdCliente" HeaderText="#" />
...
<asp:BoundField DataField="DireccionCliente" HeaderText="Direccion Cliente" />
