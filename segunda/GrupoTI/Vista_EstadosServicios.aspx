<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Vista_EstadosServicios.aspx.cs" Inherits="TuNamespace.VistaServicios" %>
...
    
        ...
        <div>
            <asp:Label ID="Label12" runat="server" Text="Estatus:" CssClass="form-label"></asp:Label>
